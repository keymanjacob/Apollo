...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<apollo-big-input-action></apollo-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<apollo-big-input-action [disabled]="true"></apollo-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<apollo-big-input-action fontSet="fas" fontIcon="trash"></apollo-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<apollo-big-input-action label="delete"></apollo-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<apollo-big-input-action (action)="actionHandler()"></apollo-big-input-action>';
    fixture = createHostComponent(template);
